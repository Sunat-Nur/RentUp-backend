...
class Company {
    ...
    async getCompaniesData(member, data) {
        try {
            const auth_mb_id = shapeIntoMongooseObjectId(member?._id);
            const match = {mb_type: "COMPANY", mb_status: "ACTIVE"};
    ...
    async getChosenCompanyData(member, id) {
        try {
            console.log("getChosenCompanyData:::::");
    ...
    async updateCompanyByAdminData(update_data) {
        try {
