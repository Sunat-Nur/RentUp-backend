...
exports.product_collection_enums = ["villa", "apartment", "etc"];
exports.product_status_enums = ["PAUSED", "PROCESS", "DELETED"];
exports.product_size_enums = ["one", "two", "three", "four", "etc"];
exports.product_discount=["10%", "15%", "20%","25%", "30%","35%", "40%","45", "50%", "60%", "70%"];
